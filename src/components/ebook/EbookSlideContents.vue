  ...
  <div class="ebook-slide-content">
    <div class="slide-contents-search-wrapper">
      <div class="slide-contents-search-input-wrapper">
        ...
        :placeholder="$t('book.searchHint')" v-model="searchText"
    ...
    <scroll class="slide-search-list" :top="60" :bottom="48" v-show="searchVisible">
      ...
      doSearch (q) {
        return Promise.all(
          this.currentBook.spine.spineItems.map(
            ...
            this.currentBook)).then(section.find.bind(
              section, q)).finally(section.unload.bind(section)))
